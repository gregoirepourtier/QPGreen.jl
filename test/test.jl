...
fm_method_calculation(Z, params, interp, cache; nb_terms=32);
...
@time for i ∈ [32, 64, 128, 256, 512, 1024]
    interp, cache = QPGreen.fm_method_preparation(params, i)
    res_fm = QPGreen.fm_method_calculation(Z, params, interp, cache; nb_terms=32)
